import { isObject, isUndefined } from '../Base/index';
...
export default function compare(key?: string | number): IFunction {
	...
	return function (arg1: ArgType, arg2: ArgType): number {
		const target1 = hasKey && isObject(arg1) ? arg1[key as keyof ArgType] : arg1;
		const target2 = hasKey && isObject(arg2) ? arg2[key as keyof ArgType] : arg2;
